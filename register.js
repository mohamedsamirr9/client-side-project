...
const registerEmail = document.querySelector('.register-form input[placeholder="Email"]');
const registerUsername = document.querySelector('.register-form input[placeholder="User Name"]');
const registerPassword = document.querySelector('.register-form input[placeholder="Password"]');
...
// login inputs
const loginUsername = document.querySelector('.login-form input[placeholder="User Name"]');
const loginPassword = document.querySelector('.login-form input[placeholder="Password"]');
